...
module.exports.run = (client, message, args) => {
    if (!args.length) {
        const embed = new Discord.MessageEmbed()
            .setTitle("Help")
            .setColor("#1E90FF")
            .addField("Liste des commandes", `La liste de toutes les commandes disponibles 
        ...
        const command = client.commands.get(args[0])
            || client.commands.find(cmd => cmd.help.aliases && cmd.help.aliases.includes(args[0]));
...
module.exports.help = {
    ...
    aliases: ['h'],
    category: 'public',
    description: "Renvoie la liste des commandes disponibles ou les informations sur une commande",
    cooldown: 0,
    usage: "<command_name>",
    permissions: false,
    isUserAdmin: false,
